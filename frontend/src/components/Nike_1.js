...
export default function Nike_1({ addToCart })
{
    ...
    addToCart({
      id: `nike1-${selectedSize}`,
      name: "Nike Shoe",
      price: 3999,
      quantity: count,
      size: selectedSize,
      image: "/images/nike-1.webp",
      description:
    ...
    return (
      ...
      <div className="product-image">
        <img src="/images/nike-1.webp" alt="Nike Shoe" />
      </div>
      ...
      <div className="product-details">
        ...
        <p className="desc">
          <b>Nike Air Zoom Racer — Built for speed and comfort with responsive Zoom Air cushioning and a lightweight mesh upper that keeps your feet cool during intense workouts.</b>
        </p>
