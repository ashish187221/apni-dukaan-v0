...
export default function Campus_2({ addToCart }) {
    ...
    if (!selectedSize) {
      ...
      return;
            ...
            addToCart({
              id: `campus2-${selectedSize}`,
              name: "Campus Shoe",
              price: 1599,
              quantity: count,
              size: selectedSize,
              image: "/images/campus-2.webp",
              description:
                "Campus PowerRun — Built for endurance with a durable rubber outsole, soft foam cushioning, and air mesh upper that keeps your feet cool during long workouts."
            });
        ...
        return (
            ...
            <img src="/images/campus-2.webp" alt="Campus Shoe" />
          </div>
          ...
          <div className="product-details">
            ...
            <p className="desc">
              <b>Campus PowerRun — Built for endurance with a durable rubber outsole, soft foam cushioning, and air mesh upper that keeps your feet cool during long workouts.</b>
            </p>
