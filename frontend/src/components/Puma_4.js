...
export default function Puma_1({ addToCart }) {
    ...
    addToCart({
      id: `puma4-${selectedSize}`,
      name: "Puma Shoe",
      price: 1599,
      quantity: count,
      size: selectedSize,
      image: "/images/puma-4.webp",
      description:
        "Puma SportFlex | Flexible design with enhanced grip, breathable fabric, and comfortable fit for workouts or casual wear."
    });
    setAdded(true);
    ...
    return (
      ...
      <div className="product-image">
        <img src="/images/puma-4.webp" alt="Puma Shoe" />
      </div>
      ...
      <div className="product-details">
        ...
        <p className="desc">
         <b> Puma SportFlex | Flexible design with enhanced grip, breathable fabric, and comfortable fit for workouts or casual wear.</b>
        </p>
