...
export default function RedTape_4({ addToCart }) {
    ...
    if (!selectedSize) {
      ...
      return;
        ...
        addToCart({
          id: `redtape4-${selectedSize}`,
          name: "RedTape Shoe",
          price: 1899,
          quantity: count,
          size: selectedSize,
          image: "/images/redTape-4.webp",
          description:
            "Designed for athletes, these shoes offer superior traction, ergonomic support, and maximum comfort during intense workouts.",
    ...
    return (
      ...
      <div className="product-image">
        <img src="/images/redTape-4.webp" alt="RedTape Shoe" />
      </div>
      ...
      <div className="product-details">
        ...
        <p className="desc">
          <b> Designed for athletes, these shoes offer superior traction, ergonomic support, and maximum comfort during intense workouts.</b>
        </p>
