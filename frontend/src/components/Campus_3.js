...
export default function Campus_3({ addToCart }) {
    ...
    if (!selectedSize) {
      ...
      return;
            ...
            addToCart({
              id: `campus3-${selectedSize}`,
              name: "Campus Shoe",
              price: 1299,
              quantity: count,
              size: selectedSize,
              image: "/images/campus-3.webp",
              description:
                "Campus XtremeFlex — High-performance shoes offering superior grip, flexibility, and ankle support — perfect for gym sessions and outdoor sports."
            });
        ...
        return (
          ...
          <div className="product-image">
            <img src="/images/campus-3.webp" alt="Campus Shoe" />
          </div>
          ...
          <div className="product-details">
            ...
            <p className="desc">
              <b>Campus XtremeFlex — High-performance shoes offering superior grip, flexibility, and ankle support — perfect for gym sessions and outdoor sports.</b>
            </p>
