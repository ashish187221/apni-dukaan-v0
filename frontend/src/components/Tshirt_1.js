    ...
    if (!selectedSize) {
      ...
      return;
            ...
            addToCart({
              ...
              description:
                "Stylish yet simple — this half-buttoned T-shirt gives you a clean, classy vibe. With its soft cotton fabric and modern collar design, it’s perfect for casual days or semi-formal hangouts."
            });
    ...
    return (
        <div className="product-container">
          <div className="product-image">
            <img src="/images/tshirt-1.webp" alt="T-Shirt" />
          </div>
          ...
          <div className="product-details">
            ...
            <p className="desc">
              <b>Stylish yet simple — this half-buttoned T-shirt gives you a clean, classy vibe. With its soft cotton fabric and modern collar design, it’s perfect for casual days or semi-formal hangouts.</b>
            </p>
