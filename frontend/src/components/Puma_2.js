...
export default function Puma_1({ addToCart }) {
    ...
    addToCart({
      id: `puma2-${selectedSize}`,
      name: "Puma Shoe",
      price: 3599,
      quantity: count,
      size: selectedSize,
      image: "/images/puma-2.webp",
      description:
        "Puma Sneaker Classic | Lightweight design with breathable mesh upper and cushioned sole for all-day comfort."
    });
    setAdded(true);
    ...
    return (
      ...
      <div className="product-image">
        <img src="/images/puma-2.webp" alt="Puma Shoe" />
      </div>
      ...
      <div className="product-details">
        ...
        <p className="desc">
          <b>Puma Sneaker Classic | Lightweight design with breathable mesh upper and cushioned sole for all-day comfort.</b>
        </p>
