  ...
  const decrement = () => {
    ...
    if (!selectedSize) {
      ...
      return;
        ...
        addToCart({
          id: `redtape3-${selectedSize}`,
          name: "RedTape Shoe",
          price: 2499,
          quantity: count,
          size: selectedSize,
        image: "/images/redTape-3.webp",
        description:
            "Red Tape Running Shoes | Lightweight design with shock-absorbing midsole, perfect for morning runs.",
    ...
    return (
      ...
      <div className="product-image">
        <img src="/images/redTape-3.webp" alt="RedTape Shoe" />
      </div>
      ...
      <div className="product-details">
        ...
        <p className="desc">
         <b> Red Tape Running Shoes | Lightweight design with shock-absorbing midsole, perfect for morning runs.</b>
        </p>
