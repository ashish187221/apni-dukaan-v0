...
export default function RedTape_1({ addToCart }) {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
       id: `redtape1-${selectedSize}`,
      name: "RedTape Shoe",
      price: 2999,
      quantity: count,
      size: selectedSize,
      image: "/images/redTape-1.webp",
      description:
        "RedTape Athleisure Shoes for Men | Cultured Round-Toe Shape, Cushioning Technology & Smart Ventilation",
    });
    setAdded(true);
  ...
  return (
    <div className="product-container">
      <div className="product-image">
        <img src="/images/redTape-1.webp" alt="RedTape Shoe" />
      </div>
      ...
      <div className="product-details">
        ...
        <p className="desc">
          <b>RedTape Athleisure Shoes for Men | Cultured Round-Toe Shape,
          Cushioning Technology & Smart Ventilation</b>
        </p>
